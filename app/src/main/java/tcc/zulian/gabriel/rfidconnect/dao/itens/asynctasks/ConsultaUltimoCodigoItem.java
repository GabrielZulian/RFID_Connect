 ...
 */
public class ConsultaUltimoCodigoItem extends AsyncTask<String, Void, String> {
    private Context context;

    ProgressDialog dialog;
    GravaItemActivity gravaItemActivity;

    public ConsultaUltimoCodigoItem(GravaItemActivity gravaItemActivity) {
        this.gravaItemActivity = gravaItemActivity;
        this.context = gravaItemActivity;
    }

    @Override
    protected void onPreExecute() {
        dialog = new ProgressDialog(gravaItemActivity);
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            String link = "http://vinhosopra.com.br/json/rfid/con_item_proximo_codigo.php";
    ...
    protected void onPostExecute(String result) {
        ...
        gravaItemActivity.edtCodigo.setText(String.valueOf(ultimoCod));
